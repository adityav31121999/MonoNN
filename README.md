...
- In standard MLP, this monomial will replace linear neuron $y = w \cdot x + b$
...
- **progress.hpp** is provided to store evaluation related structs and functions,
...
For this project, training and testing are performed, but validation is ignored.
