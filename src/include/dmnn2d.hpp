...
public:
    ...
    std::vector<float> powers;      // powers for each layer of dyMnn2d
...
// constructors
    ...
    dyMnn2d() = default;
    dyMnn2d(int inw, int inh, int outw, int layers, float order, std::string binFileAddress);
    dyMnn2d(int inw, int inh, int outw, int dim, int layers, float order, std::string binFileAddress);
    dyMnn2d(int inw, int inh, int outw, std::vector<int> width, float order, std::string binFileAddress);
