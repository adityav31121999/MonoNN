 ...
 */
void mnn::fullDataSetTraining(const std::string &dataSetPath, bool isRGB, bool useThreadOrBuffer)
{
 ...
 * @param isRGB if image is RGB 1, else 0 for grey image
 */
void mnn2d::fullDataSetTraining(const std::string &dataSetPath, bool isRGB, bool useThreadOrBuffer)
{
    std::cout << "This is fullDataSetTraining.\n";
    // Access all image files from the dataset path
    std::vector<std::filesystem::path> filePaths;
