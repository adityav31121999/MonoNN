 ...
 */
void mnn::testOnAllWeights(std::string dataSetPath, bool isRGB, bool useThreadOrBuffer)
{
    // first find all .bin files in the path
    int totalBinFiles = 0;
    std::vector<std::string> binFiles;
    std::string weightsPath = dataSetPath + "/mnn1d";
    ...
    std::cout << "\n--- Starting All Weights Test (mnn) ---" << std::endl;
    ...
    std::cout << "--- Test For All Weights Finished (mnn) ---" << std::endl;
}
