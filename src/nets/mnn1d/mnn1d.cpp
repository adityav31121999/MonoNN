...
/**
 * @brief Constructor for the mnn1d class with only in-out size.
...
/**
 * @brief Constructor for the mnn1d class in-out and layer size.
 * @param insize Input size.
 * @param outsize Output size.
...
/**
 * @brief Constructor for the mnn1d class with layer specifications.
 * @param insize Input size.
 * @param outsize Output size.
 * @param dim dimension of hidden layers
 * @param layers Number of hidden layers.
...
// mnn1d: load data of networ from binary file
...
// mnn1d: save data of network to binary file
